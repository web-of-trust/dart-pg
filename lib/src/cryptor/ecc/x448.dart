...
final class X448 {
  ...
  static Uint8List scalarMult(
    ...
    final x2 = X448Field.create();
    x2.setAll(0, x1);
    final z2 = X448Field.create();
    z2[0] = 1;
    final x3 = X448Field.create();
    x3[0] = 1;
    final z3 = X448Field.create();

    final t1 = X448Field.create();
    final t2 = X448Field.create();
  ...
  static void _pointDouble(
    ...
    final a = X448Field.create();
    final b = X448Field.create();
