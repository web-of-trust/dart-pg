...
class TwofishEngine extends BaseEngine {
  ...
  void _setupKey(final Uint8List key) {
    switch (key.length) {
      case 16:
        final list1 = _mdsrem(
          _unpack32Le(key.sublist(0)),
          _unpack32Le(key.sublist(4)),
        );
        final list2 = _mdsrem(
          _unpack32Le(key.sublist(8)),
          _unpack32Le(key.sublist(12)),
        );
      ...
      case 24:
        ...
        final list3 = _mdsrem(
          _unpack32Le(key.sublist(16)),
          _unpack32Le(key.sublist(20)),
        );
      ...
      case 32:
        ...
        final list4 = _mdsrem(
          _unpack32Le(key.sublist(24)),
          _unpack32Le(key.sublist(28)),
        );
  ...
  static int _unpack32Le(final Uint8List x) => x.unpack32Le();
  static Uint8List _pack32Le(final int x) => x.pack32Le();
}
