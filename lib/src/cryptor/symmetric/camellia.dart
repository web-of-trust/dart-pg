...
class CamelliaEngine extends BaseEngine {
  ...
  static int _bytes2uint(Uint8List src, int offset) {
    return src.sublist(offset, offset + 4).unpack32();
  }
  ...
  static int _shiftLeft32(int x, int n) => x.shiftLeft32(n);

  static int _shiftRight32(int x, int n) => x.shiftRight32(n);

  static int _rotateLeft32(int x, int n) => x.rotateLeft32(n);

  static int _rotateRight32(int x, int n) => x.rotateRight32(n);
}
