...
class TwofishEngine extends BaseCipher {
  ...
  void _setupKey(final Uint8List key) {
    switch (key.length) {
      case 16:
        final list1 = _mdsrem(key.sublist(0).toLeUint32(), key.sublist(4).toLeUint32());
        final list2 = _mdsrem(key.sublist(8).toLeUint32(), key.sublist(12).toLeUint32());
      ...
      case 24:
        final list1 = _mdsrem(key.sublist(0).toLeUint32(), key.sublist(4).toLeUint32());
        final list2 = _mdsrem(key.sublist(8).toLeUint32(), key.sublist(12).toLeUint32());
        final list3 = _mdsrem(key.sublist(16).toLeUint32(), key.sublist(20).toLeUint32());
      ...
      case 32:
        ...
        final list2 = _mdsrem(key.sublist(8).toLeUint32(), key.sublist(12).toLeUint32());
        final list3 = _mdsrem(key.sublist(16).toLeUint32(), key.sublist(20).toLeUint32());
        final list4 = _mdsrem(key.sublist(24).toLeUint32(), key.sublist(28).toLeUint32());
  ...
  void _encryptBlock(final Uint8List input, final int inOff, final Uint8List output, final int outOff) {
    ...
    output.setAll(outOff, (r2 ^ _subKeys[4]).toLe32Bytes());
    output.setAll(outOff + 4, (r3 ^ _subKeys[5]).toLe32Bytes());
    output.setAll(outOff + 8, (r0 ^ _subKeys[6]).toLe32Bytes());
    output.setAll(outOff + 12, (r1 ^ _subKeys[7]).toLe32Bytes());
  }
  ...
  void _decryptBlock(final Uint8List input, final int inOff, final Uint8List output, final int outOff) {
    ...
    output.setAll(outOff, (r2 ^ _subKeys[0]).toLe32Bytes());
    output.setAll(outOff + 4, (r3 ^ _subKeys[1]).toLe32Bytes());
    output.setAll(outOff + 8, (r0 ^ _subKeys[2]).toLe32Bytes());
    output.setAll(outOff + 12, (r1 ^ _subKeys[3]).toLe32Bytes());
  }
