...
class TwofishEngine extends BaseCipher {
  ...
  void _setupKey(final Uint8List key) {
    switch (key.length) {
      case 16:
        final list1 =
            _mdsrem(key.sublist(0).toLeUint32(), key.sublist(4).toLeUint32());
        final list2 =
            _mdsrem(key.sublist(8).toLeUint32(), key.sublist(12).toLeUint32());
      ...
      case 24:
        ...
        final list2 =
            _mdsrem(key.sublist(8).toLeUint32(), key.sublist(12).toLeUint32());
        final list3 =
            _mdsrem(key.sublist(16).toLeUint32(), key.sublist(20).toLeUint32());
      ...
      case 32:
        ...
        final list3 =
            _mdsrem(key.sublist(16).toLeUint32(), key.sublist(20).toLeUint32());
        final list4 =
            _mdsrem(key.sublist(24).toLeUint32(), key.sublist(28).toLeUint32());
