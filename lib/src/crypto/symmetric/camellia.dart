...
class CamelliaEngine extends BaseCipher {
  ...
  static void _camelliaF2(List<int> s, List<int> skey, int keyoff) {
    ...
    u ^= _sbox3033[(t1 >> 8) & _mask8];
    u ^= _sbox0222[(t1 >> 16) & _mask8];
    u ^= _sbox1110[(t1 >> 24) & _mask8];
    t2 = s[1] ^ skey[1 + keyoff];
    v = _sbox1110[t2 & _mask8];
    v ^= _sbox4404[(t2 >> 8) & _mask8];
    v ^= _sbox3033[(t2 >> 16) & _mask8];
